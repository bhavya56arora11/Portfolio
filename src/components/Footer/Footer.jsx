...
export default function Footer() {
  ...
  return (
    <footer id="footer" ref={footerRef} className="footer-section">
      <div className="footer-bg-line line-1"></div>
      <div className="footer-bg-line line-2"></div>
      <div className="footer-bg-line line-3"></div>
            ...
            <ul className="social-icons">
              ...
              >
                <a
                  data-social="mail"
                  aria-label="Email"
                  href="mailto:bhavya56arora11@gmail.com"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="icon-fill"></div>
              ...
              >
                <a
                  data-social="github"
                  aria-label="GitHub"
                  href="https://github.com/bhavya56arora11"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="icon-fill"></div>
              ...
              >
                <a
                  ...
                  aria-label="Telegram"
                  href="https://t.me/bhavyaarora5611"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="icon-fill"></div>
                  ...
                  <span className="icon-tooltip">Telegram</span>
                </a>
              </li>
              <li
              ...
              >
                <a
                  ...
                  aria-label="LinkedIn"
                  href="https://www.linkedin.com/in/bhavya-arora-b149aa24a/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <div className="icon-fill"></div>
